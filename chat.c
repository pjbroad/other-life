...
int display_channel_color_win(Uint32 channel_number)
{
	...
	if(channel_color_win < 0) 
	{
		...
		/* Add labels */
		x = 10;
		color_label_id = label_add_extended(channel_color_win, color_label_id, NULL, x, y, 0, 0.9f, newcol_r, newcol_g, newcol_b, channel_color_str);
		/* Add color buttons */
		y += 24;
		...
		y += 44;
		color_set_button_id = button_add_extended(channel_color_win, color_set_button_id, NULL, x, y, 110, 30, 0, 1.0, newcol_r, newcol_g, newcol_b, channel_color_add_str);
		widget_set_OnClick(channel_color_win, color_set_button_id, click_channel_color_handler);
		x += x + 110;
		color_delete_button_id = button_add_extended(channel_color_win, color_delete_button_id, NULL, x, y, 110, 30, 0, 1.0, newcol_r, newcol_g, newcol_b, channel_color_delete_str);
