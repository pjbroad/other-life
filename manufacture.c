...
void display_manufacture_menu()
{
	if(manufacture_win < 0){
		...
		mixone_button_id=button_add_extended(manufacture_win, mixone_button_id, NULL,
			manufacture_menu_x_len-2*(mbw+space), manufacture_menu_y_len-buty, mbw, 0, 0, 1.0f, newcol_r, newcol_g, newcol_b, ">");
		...
		mixall_button_id=button_add_extended(manufacture_win, mixall_button_id, NULL,
			manufacture_menu_x_len-(mbw+space), manufacture_menu_y_len-buty, mbw, 0, 0, 1.0f, newcol_r, newcol_g, newcol_b, ">>");
		...
		clear_button_id=button_add_extended(manufacture_win, clear_button_id, NULL,
			space, manufacture_menu_y_len-buty, cbw, 0, 0, 1.0f, newcol_r, newcol_g, newcol_b, clear_str);
		...
		recipe_win_scroll_id = vscrollbar_add_extended(recipe_win, 1, NULL, recipe_win_width-ELW_BOX_SIZE,
			0, ELW_BOX_SIZE, num_displayed_recipes*SLOT_SIZE - ELW_BOX_SIZE, 0, 1.0, newcol_r, newcol_g, newcol_b,
