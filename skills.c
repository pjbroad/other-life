...
void fill_skills_win ()
{
	...
	skills_menu_scroll_id = vscrollbar_add_extended(skills_win, skills_menu_scroll_id, NULL, skills_menu_x_len-20, 0, 20, skills_menu_y_len, 0, 1.0, newcol_r, newcol_g, newcol_b, 0, 30, Page[skillspage].max_y);
}
