...
void fill_knowledge_win (int window_id)
{
	...
	knowledge_scroll_id = vscrollbar_add_extended (window_id, knowledge_scroll_id, NULL, 0,  0, 0, 0, 0, 1.0, newcol_r, newcol_g, newcol_b, 0, 1, (knowledge_count+1)/2-displayed_book_rows);
