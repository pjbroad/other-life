...
#ifdef OTHER_LIFE
	draw_string_shadowed_zoomed((int)((window_width - strlen(license_str) * win->default_font_len_x) / 2), window_height - 2 * win->default_font_len_y, (unsigned char *)license_str, 1, 1.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f, win->current_scale);
#endif
